...
class JourneysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create journey" do
    assert_difference("Journey.count") do
      post journeys_url, params: { journey: { reason: @journey.reason, timeblocks: @journey.timeblocks, title: @journey.title } }
    end
  ...
  test "should update journey" do
    patch journey_url(@journey), params: { journey: { reason: @journey.reason, timeblocks: @journey.timeblocks, title: @journey.title } }
