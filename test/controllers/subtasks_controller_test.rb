...
class SubtasksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subtask" do
    assert_difference("Subtask.count") do
      post subtasks_url, params: { subtask: { left_of_at: @subtask.left_of_at, name: @subtask.name } }
    end
  ...
  test "should update subtask" do
    patch subtask_url(@subtask), params: { subtask: { left_of_at: @subtask.left_of_at, name: @subtask.name } }
